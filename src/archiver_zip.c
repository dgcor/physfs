...
static ZIPentry *zip_hash_ancestors(ZIPinfo *info, char *name)
{
    ...
    if (sep)
    {
        ...
        *sep = '/';
        ...
        retval = (ZIPentry *) physfs_alloc.Malloc(sizeof (ZIPentry) + namelen);
                                ...
                                const PHYSFS_uint64 ofs_fixup)
{
    ...
    retval = (ZIPentry *) physfs_alloc.Malloc(sizeof (ZIPentry) + fnamelen + 1);
...
static int zip_alloc_hashtable(ZIPinfo *info, const PHYSFS_uint64 entry_count)
{
    ...
    info->hash = (ZIPentry **) physfs_alloc.Malloc(alloclen);
